...
twitter_data_human <- collect(spark_read_parquet(sc, 
                                           "twitter_data_human",
                                           "/home/mavram/Projects/OpenKasm/TwitterReposAnalysis/output-analysis/test2/"))
twitter_data_bot <- collect(spark_read_parquet(sc, 
                                           "twitter_data_bot",
                                           "/home/mavram/Projects/OpenKasm/TwitterReposAnalysis/output-analysis/test2/"))
twitter_data_human <- as.data.frame(twitter_data_human)
twitter_data_bot <- as.data.frame(twitter_data_bot)
```
...
twitter_data_human$is_bot <- 0
twitter_data_bot$is_bot <- 1
...
twitter_data_human <- add_factors(twitter_data_human, factor_columns)
twitter_data_bot <- add_factors(twitter_data_bot, factor_columns)
...
twitter_feature_data_human <- get_feature_data(twitter_data_human, T, F)
twitter_feature_data_bot <- get_feature_data(twitter_data_bot, T, F)
...
```{r}
twitter_data <- rbind(twitter_feature_data_human, twitter_feature_data_bot)
...
tasks <- list( 
  makeClassifTask(id="TwitterData", data=twitter_data, target="is_bot", positive="1"),
  smote(makeClassifTask(id="TwitterDataSmote", data=twitter_data, target="is_bot", positive="1"), rate=1.33)
)
